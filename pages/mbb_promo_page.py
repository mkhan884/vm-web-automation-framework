...
class MbbPromoPage(BasePage):
    ...
    PAGE_HEADER = (By.XPATH, '//h1[text()="Limited time offer"]')
    CARD_TITLE = (By.XPATH, '//h3[normalize-space(.)="Home Internet for 12 months"]')
    ROUTER_IMG = (By.XPATH, "//h3[contains(.,'Home Internet for') and contains(.,'12 months')]")
    ...
    def choose_plan(self):
        ...
        self.scroll_to(self.ONE_MONTH_TAB).click()
